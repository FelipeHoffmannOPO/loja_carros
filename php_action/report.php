...
<html lang="pt-br">
  ...
  <body>
    ...
    <button class="btn-large orange right"onclick="window.print()">IMPRIMIR</button>
    <div class="section no-pad-bot" id="index-banner">
      <div class="container">
        <br /><br />
        <div class="row center">
        <img src="../assets/imagens/Estrela Motors.png" whidt="100px" />
          <div class="col s12">
